...
class Hdf5(AutotoolsPackage):
    ...
    def configure_args(self):
        ...
        # attempting cross compile hacks for theta , FTW
        #extra_args.append('--build=linux-sles12-x86_64')
        #extra_args.append('--build=x86_64')
        #extra_args.append('--host=cray-cnl8-mic_knl')
        #extra_args.append('--host=mic_knl')
